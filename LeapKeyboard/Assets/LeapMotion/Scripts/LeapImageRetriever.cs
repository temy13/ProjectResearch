...
public class LeapImageRetriever : MonoBehaviour
{
  ...
  protected void SetRenderer(ref Leap.Image image)
  {
  ...
  protected bool InitiateTexture(ref Leap.Image image)
  {
  ...
  protected bool InitiateDistortion(ref Leap.Image image)
  {
  ...
  protected bool InitiatePassthrough(ref Leap.Image image)
  {
  ...
  protected void LoadMainTexture(ref Leap.Image image)
  {
  ...
  protected bool LoadDistortion(ref Leap.Image image)
  {
  ...
  void Update()
  {
    ...
    Leap.Image image = frame.Images[imageIndex];
